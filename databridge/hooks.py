...
# Includes in <head>
app_include_css = [
    "/assets/databridge/css/databridge-theme.css",
    "/assets/databridge/css/databridge-variables.css",
]
app_include_js = [
    "/assets/databridge/js/databridge_boot.js",
    "/assets/databridge/js/fv_integration.js",
]

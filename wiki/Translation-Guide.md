...
```bash
bench --site dev.localhost get-untranslated ar --app databridge
```

### 2. Translation file format — تنسيق ملف الترجمة

File: `databridge/translations/ar.csv`
...
bench --site dev.localhost get-untranslated ar --app databridge | wc -l
```
...
2. Edit/create the CSV file in `databridge/translations/`

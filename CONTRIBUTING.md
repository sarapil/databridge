# Contributing to **APP_TITLE** — المساهمة في **APP_TITLE**
...
```bash
bench get-app databridge /path/to/your/fork
bench --site dev.localhost install-app databridge
...
bench --site dev.localhost run-tests --app databridge

# Run specific test — تشغيل اختبار محدد
bench --site dev.localhost run-tests --app databridge --module databridge.tests.unit.test_my_service
```
...
- Update help files in `databridge/help/` for DocType changes
